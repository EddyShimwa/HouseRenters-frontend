...
import SplashPage from "./componentsFolder/splash";
    ...
    <div>
      ...
      >
        ...
        <Route path="/" element={<SplashPage />} exact />
          ...
          <Route
            path="/paymentpage/:Newtoken/:id"
            element={<PaymentPage></PaymentPage>}
            exact
          />
          <Route
            path="/updaterental"
            element={<UpdateRental></UpdateRental>}
            exact
          />
          <Route
            path="/logedinhousedescription/:houseId/:Newtoken"
            element={
              <HouseDescriptionWhenLogedIn></HouseDescriptionWhenLogedIn>
            }
            exact
          />
          <Route
            path="/allhouses/:Newtoken"
            element={<ALLhouses></ALLhouses>}
            exact
          />
          <Route
            path="/dashboard/:newToken"
            element={<LandLoadDashboard></LandLoadDashboard>}
          />
          <Route
            path="/housedescription/:houseId"
            element={<HouseDescription></HouseDescription>}
          />
          <Route
            path="/addnewrental/:newToken"
            element={<AddnewRental></AddnewRental>}
          />
          <Route path="/orders" element={<Orders></Orders>} />
          <Route
            path="/rentallist/:newToken"
            element={<RentalList></RentalList>}
          />
          <Route
            path="/userDashboard/:houseId/:token"
            element={<UserDashboard></UserDashboard>}
          />
          <Route
            path="/studentstatuspage/:Newtoken"
            element={<StudentStatusPage></StudentStatusPage>}
          />
          <Route
            path="/bookingstatuspage/:newToken2/:itemId"
            element={<BookingStatusPage></BookingStatusPage>}
          />
        </Routes>
      </OpenModalContext.Provider>
    </div>
