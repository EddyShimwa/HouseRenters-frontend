      ...
      <div className=" flex justify-center mt-16">
        ...
        <div className="  ml-52">
          <button
            ...
            type="button"
            class="text-white hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
          >
            Book Now
          </button>
        </div>
